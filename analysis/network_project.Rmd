...
plot_robustness(df_ext_degree_wild, title="Degree-based attack (Wild bacterial + fungal network)")
# (1-2) Betweenness
df_ext_bt_wild <- get_extinction_df(wild_web, order="Betweenness", n_lines=50)
plot_robustness(df_ext_bt_wild, title="Betweenness-based attack (Wild bacterial + fungal network)")
# (1-3) Eigen_centrality
df_ext_eigen_wild <- get_extinction_df(wild_web, order="Eigen_centrality", n_lines=50)
plot_robustness(df_ext_eigen_wild, title="Eigen_centrality-based attack (Wild bacterial + fungal network)")
# (1-4) Random
df_ext_random_wild <- get_extinction_df(wild_web, order="Random", n_lines=50)
plot_robustness(df_ext_random_wild, title="Random-based attack (Wild bacterial + fungal network)")

# plot the average in 1 plot
colnames(df_ext_degree_wild)
df_ext_degree_wild %>% group_by(Removed)
