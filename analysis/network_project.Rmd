...
# remove type column
wild_edge_BFn <- wild_edge_new %>% select(-type)
...
get_nestedness <- function(wild_web){
  # Prune and make it into Bipartite
  get.edgelist(wild_web) %>% dim()
  wild_edge <- get.edgelist(wild_web) 
  class(wild_edge)
...
wild_nest <- get_nestedness(wild_web)
dom_nest <- get_nestedness(domestic_web)
...
Bipartite and modularity
```{r}
# modularity
# mod <- computeModules(wild_bipartite_mat)
slotNames(mod)
...
plot_motif(wild_web, title = "Motif relative abundance (Wild)")
plot_motif(b_wild_web, title = "Motif relative abundance (Wild)")
# plot_motif(f_wild_web, title = "Motif relative abundance (Wild)")

plot_motif(domestic_web, title = "Motif relative abundance (Wild)")
plot_motif(b_domestic_web, title = "Motif relative abundance (Wild)")
